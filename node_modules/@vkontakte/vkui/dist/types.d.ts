 ...
 */
export type AnchorHTMLAttributesOnly = Omit<React.AnchorHTMLAttributes<HTMLAnchorElement>, keyof React.HTMLAttributes<HTMLAnchorElement>> & React.AriaAttributes;
/**
...
export type PartialFields<TYPE, FIELDS extends keyof TYPE> = Omit<TYPE, FIELDS> & Partial<Pick<TYPE, FIELDS>>;
export type RequiredFields<TYPE, FIELDS extends keyof TYPE> = Omit<TYPE, FIELDS> & Required<Pick<TYPE, FIELDS>>;
...
export type DeepReadonly<T> = Readonly<{
    [K in keyof T]: T[K] extends number | string | symbol ? Readonly<T[K]> : T[K] extends any[] ? Readonly<DeepReadonly<T[K]>> : DeepReadonly<T[K]>;
}>;
