...
export type PaddingProp = LiteralUnion<DesignSystemSize | CSSGlobalValue | 'system', number | string>;
...
export type FlexBasisProp = LiteralUnion<CSSIntrinsicSizingKeywords | 'content' | CSSGlobalValue, number | string>;
