...
export declare const convertDateToTimeZone: (date?: Date | null | undefined, timezone?: string | undefined) => Date | undefined | null;
export declare const convertDateFromTimeZone: (date: Date | null, timezone?: string) => Date | null;
...
export declare function createDateInTimeZone(baseDate: Date, timezone?: string, overrides?: CreateDateInTimeZoneOverrides): Date;
