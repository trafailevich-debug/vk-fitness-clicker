 ...
 *
 * - smallTabletMinus (mobile)  -> mode="plain"
 * - smallTabletPlus (desktop) -> mode="card"
 */
...
.modeCard,
.viewWidthSmallTabletPlus.modeNone {
...
.viewWidthSmallTabletMinus.modeCard {
  --vkui_internal--Group_padding_inline: 0;
...
.viewWidthSmallTabletMinus.modeCard:first-of-type {
...
@media (max-width: 767.9px) {
  .viewWidthNone.modeCard:first-of-type {
    border-start-start-radius: 0;
    border-start-end-radius: 0;
    border-end-start-radius: var(--vkui--size_border_radius_promo--regular);
    border-end-end-radius: var(--vkui--size_border_radius_promo--regular);
...
.modeCard::before,
.viewWidthSmallTabletPlus.modeNone::before {
  position: absolute;
  inset-block-start: 0;
...
.viewWidthSmallTabletMinus.modeCard::before {
  box-shadow: none;
}

@media (max-width: 767.9px) {
  .viewWidthNone.modeCard::before {
    box-shadow: none;
  }
}
...
.viewWidthSmallTabletMinus.modeNone:not(:first-of-type) > .header {
  margin-block-start: calc(-1 * var(--vkui--spacing_size_m));
}

@media (max-width: 767.9px) {
  .viewWidthNone.modeNone:not(:first-of-type) > .header {
    margin-block-start: calc(-1 * var(--vkui--spacing_size_m));
  }
}

.modeCard > .header,
.viewWidthSmallTabletPlus.modeNone > .header {
  margin-block-start: calc(-1 * var(--vkui--spacing_size_xs));
}

@media (min-width: 768px) {
  .viewWidthNone.modeNone > .header {
    margin-block-start: calc(-1 * var(--vkui--spacing_size_xs));
  }
}
...
.viewWidthSmallTabletMinus.modeNone + .separatorSibling {
...
@media (max-width: 767.9px) {
  .viewWidthNone.modeNone + .separatorSibling {
    --vkui_internal--Group__separator_hr: block;
...
@media (max-width: 767.9px) {
  .viewWidthNone.modeNone:last-of-type + .separatorSibling:not(.separatorSiblingForced) {
    display: none;
  }
}
...
.viewWidthSmallTabletPlus.modeNone + .separatorSibling {
...
.viewWidthSmallTabletMinus.modeCard + .separatorSibling {
  block-size: var(--vkui--spacing_size_m);
  padding-block: calc(var(--vkui--spacing_size_m) / 2);
}

@media (max-width: 767.9px) {
  .viewWidthNone.modeCard + .separatorSibling {
    block-size: var(--vkui--spacing_size_m);
    padding-block: calc(var(--vkui--spacing_size_m) / 2);
  }
}
