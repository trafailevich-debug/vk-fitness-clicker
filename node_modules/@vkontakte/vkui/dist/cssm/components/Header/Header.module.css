...
@media (max-width: 767.9px) {
  /* stylelint-disable selector-pseudo-class-disallowed-list */
  :global(.vkuiInternalGroup--viewWidth-none.vkuiInternalGroup--mode-none):not(:first-of-type)
    > .host:first-child,
  :global(.vkuiInternalGroup--viewWidth-none.vkuiInternalGroup--mode-none):not(:first-of-type)
    > :global(.vkuiInternalTappable):first-child
    > .host {
...
@media (min-width: 768px) {
  /* stylelint-disable selector-pseudo-class-disallowed-list */
  :global(.vkuiInternalGroup--viewWidth-none.vkuiInternalGroup--mode-none)
