 ...
 * @since 5.10.0
 * @private
 */ export const CustomSelectInput = ({ style: rootStyle, className: rootClassName, getRootRef: rootGetRootRef, align = 'left', getRef, before, after, status, children, placeholder: placeholderProp, selectType = 'default', multiline, fetching, labelTextTestId, searchable, accessible, slotProps, ...restProps })=>{
    ...
    const { className: inputClassName, value, readOnly, disabled, placeholder, ...inputProps } = useMergeProps({
        getRootRef: getRef,
    ...
    return /*#__PURE__*/ _jsx(FormField, {
        Component: "div",
        style: style,
        className: classNames(styles.host, align === 'right' && styles.alignRight, align === 'center' && styles.alignCenter, !children && styles.empty, multiline && styles.multiline, density !== 'regular' && densityClassNames[density], before && styles.hasBefore, after && styles.hasAfter, inputHidden && styles.inputHidden, labelHidden && styles.labelHidden, accessible && styles.accessible, value && styles.hasInputValue, className),
