...
disabled, required, autoFocus, id, name, form, onClick, onFocus, onBlur, slotProps, ...restProps })=>{
    ...
    return /*#__PURE__*/ _jsxs(FormField, {
        Component: "div",
        className: classNames(styles.host, 'vkuiInternalNativeSelect', before && styles.hasBefore, empty && styles.empty, multiline && styles.multiline, align === 'center' && styles.alignCenter, align === 'right' && styles.alignRight, density !== 'regular' && densityClassNames[density], className),
        style: style,
