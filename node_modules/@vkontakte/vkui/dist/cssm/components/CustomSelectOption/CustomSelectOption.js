 ...
 */ export const CustomSelectOption = ({ children, hierarchy = 0, hovered: hoveredProp, selected, before, after, description, disabled, textNoWrap, style: styleProp, className, onClick, ...restProps })=>{
    ...
    return /*#__PURE__*/ _jsxs(Paragraph, {
        ...
        className: classNames(styles.host, density !== 'compact' && densityClassNames[density], hovered && styles.hover, disabled && styles.disabled, hierarchy > 0 && styles.hierarchy, className),
        ...
        children: [
            ...
            /*#__PURE__*/ _jsxs("div", {
                ...
                children: [
                    /*#__PURE__*/ _jsx("div", {
                        className: classNames(styles.children, textNoWrap && styles.textNoWrap),
                        children: children
                    }),
