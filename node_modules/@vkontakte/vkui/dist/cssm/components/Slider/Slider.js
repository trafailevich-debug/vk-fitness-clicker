 ...
 */ export const Slider = ({ step = 1, min = 0, max = 100, value: valueProp, multiple: multipleProp, defaultValue = multipleProp ? [
    ...
    return /*#__PURE__*/ _jsxs(Touch, {
        ...
        className: classNames(styles.host, disabled && styles.disabled, density !== 'regular' && densityClassNames[density], sizeClassNames[size], multiple && styles.multiple, isRtl && styles.rtl, className),
