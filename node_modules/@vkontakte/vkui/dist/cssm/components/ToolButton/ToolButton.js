 ...
 */ export const ToolButton = ({ mode = 'primary', appearance = 'accent', direction = 'row', children, IconCompact, IconRegular, rounded, ...restProps })=>{
    ...
    return /*#__PURE__*/ _jsxs(Tappable, {
        ...
        baseClassName: classNames(styles.host, rounded && getRoundedClassName(direction, hasChildren), hasChildren && direction === 'row' && styles.withFakeEndIcon, stylesMode[mode], stylesAppearance[appearance], stylesDirection[direction], density !== 'compact' && densityClassNames[density]),
        ...restProps,
        children: [
