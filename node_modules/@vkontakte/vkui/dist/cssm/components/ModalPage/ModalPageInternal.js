...
import { isSizeXRegularFallback, useAdaptivityWithJSMediaQueries } from "../../hooks/useAdaptivityWithJSMediaQueries.js";
        ...
        children: [
            ...
            /*#__PURE__*/ _jsx(FocusTrap, {
                ...
                children: /*#__PURE__*/ _jsx(RootComponent, {
                    ...
                    role: "dialog",
                    "aria-modal": "true",
                    className: classNames(className, styles.host, isDesktop ? styles.hostDesktop : styles.hostMobile, !isDesktop && (hasCustomPanelHeaderAfter ? styles.hostMobileSafeAreaInsetTopWithCustomOffset : styles.hostMobileSafeAreaInsetTop), desktopMaxWidthClassName, isSizeXRegularFallback(viewWidth, legacySizeX, legacySizeXContext) && 'vkuiInternalModalPage--viewWidth-smallTabletPlus'),
...
function resolveDesktopMaxWidth(desktopMaxWidth = 's') {
    ...
    const style = className ? undefined : {
