...
.viewWidthSmallTabletPlus.shadow .in {
  box-shadow: 0 0 4px rgb(0, 0, 0, 0.08);
}

@media (min-width: 768px) {
  .viewWidthNone.shadow .in {
    box-shadow: 0 0 4px rgb(0, 0, 0, 0.08);
  }
}
...
.densityCompact:not(.vkcom) .contentIn {
  font-size: 20px;
}

@media (pointer: fine) and (min-width: 768px),(max-height: 414.9px) {
  .densityNone:not(.vkcom) .contentIn {
    font-size: 20px;
  }
}
...
.vkcom.viewWidthSmallTabletPlus:not(:global(.vkuiInternalModalPageHeader__in)):not(.sep):not(.trnsp)
.in::after {
  position: absolute;
  inset-block-end: 0;
...
@media (min-width: 768px) {
  /* stylelint-disable-next-line selector-pseudo-class-disallowed-list */
  .vkcom.viewWidthNone:not(:global(.vkuiInternalModalPageHeader__in)):not(.sep):not(.trnsp)
  .in::after {
    position: absolute;
    inset-block-end: 0;
    inset-inline: var(--vkui--size_border--regular);
...
.vkcom.viewWidthSmallTabletPlus:not(:global(.vkuiInternalModalPageHeader__in)):not(.trnsp) .in {
  border-block-end: 0;
...
@media (min-width: 768px) {
  /* stylelint-disable-next-line selector-pseudo-class-disallowed-list */
  .vkcom.viewWidthNone:not(:global(.vkuiInternalModalPageHeader__in)):not(.trnsp) .in {
    border-block-end: 0;
    border-start-start-radius: var(--vkui--size_border_radius_paper--regular);
    border-start-end-radius: var(--vkui--size_border_radius_paper--regular);
    box-shadow: 0 0 0 var(--vkui--size_border--regular) var(--vkui--color_field_border_alpha) inset;
...
.viewWidthSmallTabletPlus.hasSpacingDelimiter {
  margin-block-end: var(--vkui--spacing_size_2xl);
}

@media (min-width: 768px) {
  .viewWidthNone.hasSpacingDelimiter {
    margin-block-end: var(--vkui--spacing_size_2xl);
  }
}
