...
.densityCompact :global(.vkuiIcon--16),
/* stylelint-disable-next-line selector-pseudo-class-disallowed-list */
.densityCompact :global(.vkuiIcon--16.vkuiIcon--w-8) {
  padding: 14px;
}
...
.densityCompact :global(.vkuiIcon--24) {
  padding: 10px;
}
...
.densityCompact :global(.vkuiIcon--28) {
  padding: 8px;
}
...
@media (pointer: fine) and (min-width: 768px),(max-height: 414.9px) {
  ...
  /* stylelint-disable-next-line selector-pseudo-class-disallowed-list */
  .densityNone :global(.vkuiIcon--16),
  /* stylelint-disable-next-line selector-pseudo-class-disallowed-list */
  .densityNone :global(.vkuiIcon--16.vkuiIcon--w-8) {
    padding: 14px;
  }

  /* stylelint-disable-next-line selector-pseudo-class-disallowed-list */
  .densityNone :global(.vkuiIcon--24) {
    padding: 10px;
  }

  /* stylelint-disable-next-line selector-pseudo-class-disallowed-list */
  .densityNone :global(.vkuiIcon--28) {
    padding: 8px;
  }
}
...
:global(.vkuiInternalFormField__after) .densityCompact {
...
@media (pointer: fine) and (min-width: 768px),(max-height: 414.9px) {
  /* stylelint-disable-next-line selector-pseudo-class-disallowed-list */
  :global(.vkuiInternalFormField__after) .densityNone {
    inline-size: var(--vkui--size_field_height--compact);
    block-size: var(--vkui--size_field_height--compact);
  }

  /* stylelint-disable selector-pseudo-class-disallowed-list */
  :global(.vkuiInternalFormItem--removable) :global(.vkuiInternalRemovable__content) > .densityNone,
  :global(.vkuiInternalFormLayoutGroup--removable)
    :global(.vkuiInternalRemovable__content)
    > .densityNone {
    block-size: var(--vkui--size_field_height--compact);
