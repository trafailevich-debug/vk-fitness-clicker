 ...
 */ export const FormItem = ({ children, top, topId, topMultiline = false, topComponent: topComponentProp, bottom, status = 'default', removable, onRemove, removePlaceholder = 'Удалить', getRootRef, htmlFor, bottomId, noPadding, required = false, disabled, ...restProps })=>{
    ...
    return /*#__PURE__*/ _jsx(RootComponent, {
        ...restProps,
        getRootRef: rootEl,
        baseClassName: classNames(styles.host, !noPadding && styles.withPadding, 'vkuiInternalFormItem', status !== 'default' && stylesStatus[status], density !== 'regular' && densityClassNames[density], hasReactNode(top) && classNames(styles.withTop, 'vkuiInternalFormItem--withTop'), removable && classNames(styles.withRemovable, 'vkuiInternalFormItem--removable')),
