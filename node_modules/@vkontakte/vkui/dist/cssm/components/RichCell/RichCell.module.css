...
.contentAlignCenter .in {
  justify-content: center;
}

.contentAlignStart .in {
...
.densityCompact .children,
.densityCompact .subtitle,
.densityCompact .afterChildren {
  font-size: var(--vkui--font_subhead--font_size--regular);
  line-height: var(--vkui--font_subhead--line_height--regular);
}

@media (pointer: fine) and (min-width: 768px),(max-height: 414.9px) {
  .densityNone .children,
  .densityNone .subtitle,
  .densityNone .afterChildren {
    font-size: var(--vkui--font_subhead--font_size--regular);
    line-height: var(--vkui--font_subhead--line_height--regular);
  }
}
