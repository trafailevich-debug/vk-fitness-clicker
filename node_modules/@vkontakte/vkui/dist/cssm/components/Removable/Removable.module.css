...
:global(.vkuiInternalFormItem--density-compact):global(.vkuiInternalFormItem--withTop)
  :global(.vkuiInternalFormItem__removable)
  ~ .offset,
:global(.vkuiInternalFormLayoutGroup--density-compact):global(
...
@media (pointer: fine) and (min-width: 768px),(max-height: 414.9px) {
  /* stylelint-disable selector-pseudo-class-disallowed-list */
  :global(.vkuiInternalFormItem--density-none):global(.vkuiInternalFormItem--withTop)
    :global(.vkuiInternalFormItem__removable)
    ~ .offset,
  :global(.vkuiInternalFormLayoutGroup--density-none):global(
      .vkuiInternalFormLayoutGroup--removable
    )
    :global(.vkuiInternalFormItem--withTop)
    ~ .offset {
