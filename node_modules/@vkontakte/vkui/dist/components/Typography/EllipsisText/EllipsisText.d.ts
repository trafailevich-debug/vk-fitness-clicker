...
export interface EllipsisTextProps extends Omit<RootComponentProps<HTMLElement>, 'title'>, HasRootRef<HTMLElement> {
    /**
 ...
 */
declare const EllipsisText: ({ Component, className, children, maxWidth, maxLines, disableNativeTitle, ...restProps }: EllipsisTextProps) => React.ReactNode;
export { EllipsisText };
