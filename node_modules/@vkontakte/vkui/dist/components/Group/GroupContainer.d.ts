...
export type GroupContainerProps = HTMLAttributesWithRootRef<HTMLElement> & HasComponent & {
    /**
...
export declare const GroupContainer: ({ children, separator, mode: modeProps, padding, tabIndex: tabIndexProp, ...restProps }: GroupContainerProps) => import("react/jsx-runtime").JSX.Element;
