...
export declare const usePopover: <ElementType extends HTMLElement = HTMLElement>({ getRootRef, arrow: withArrow, arrowHeight, arrowPadding, placement, onPlacementChange, disableFlipMiddleware, disableShiftMiddleware, trigger, strategy, content, hoverDelay, closeAfterClick, offsetByMainAxis, offsetByCrossAxis, sameWidth, hideWhenReferenceHidden, onReferenceHiddenChange, disabled, disableInteractive, disableCloseOnClickOutside, disableCloseOnEscKey, keepMounted, customMiddlewares, defaultShown, shown: shownProp, onShownChange, onShownChanged, usePortal, arrowProps, ArrowIcon, autoFocus, restoreFocus, className, noStyling, zIndex, disableFocusTrap, role, ...restPopoverProps }: UsePopoverProps) => UsePopoverResult<ElementType>;
