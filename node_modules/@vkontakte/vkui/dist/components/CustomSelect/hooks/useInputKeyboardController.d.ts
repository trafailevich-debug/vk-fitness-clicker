...
export declare function useInputKeyboardController({ opened, resetFocusedOption, focusOption, scrollBoxRef, selectFocused, onInputKeyDown, open, close, }: UseInputKeyboardController): (event: React.KeyboardEvent<HTMLInputElement>) => void;
export {};
