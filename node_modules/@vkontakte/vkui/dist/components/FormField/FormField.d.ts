 ...
 */
export declare const FormField: ({ Component, status, children, getRootRef, before, after, beforeAlign, afterAlign, disabled, mode, className, maxHeight, style, onMouseEnter, onMouseLeave, ...restProps }: FormFieldOwnProps) => React.ReactNode;
