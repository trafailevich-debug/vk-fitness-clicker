 ...
 * @public
 */
export interface ChipsInputBaseProps<O extends ChipOption = ChipOption> extends UseChipsInputBaseOnlyNeededProps<O>, Pick<React.InputHTMLAttributes<HTMLInputElement>, 'readOnly' | 'onFocus' | 'onBlur' | 'placeholder'>, Omit<React.HTMLAttributes<HTMLDivElement>, 'onChange' | 'onFocus' | 'onBlur' | 'defaultValue'>, HasRootRef<HTMLDivElement>, HasAlign {
    /**
     ...
     */
    slotProps?: {
        root?: (React.HTMLAttributes<HTMLDivElement> & HasRootRef<HTMLDivElement> & HasDataAttribute) | undefined;
