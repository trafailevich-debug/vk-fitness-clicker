 ...
 * @public
 */
export type TooltipArrowProps = Omit<FloatingArrowPropsPrivate, 'getRootRef' | 'coords' | 'placement' | 'Icon'>;
/**
 * @alias
 * @public
 */
 ...
 */
export declare const Tooltip: ({ children, ...restProps }: TooltipProps) => React.ReactNode;
export {};
