...
export type ModalCardCloseReason = 'click-overlay' | 'click-close-button' | 'escape-key' | 'swipe-down';
export interface ModalCardProps extends NavIdProps, Omit<ModalCardBaseProps, 'id' | 'onClose' | 'onTransitionEnd' | keyof UseBottomSheetHandlers> {
    /**
     * Состояние видимости.
     *
     * @default false
