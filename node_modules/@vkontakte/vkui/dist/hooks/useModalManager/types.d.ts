...
type UpdateArgs = [id: string, type: 'card', props: Omit<OpenModalCardProps, 'id'>] | [id: string, type: 'page', props: Omit<OpenModalPageProps, 'id'>];
...
export type CustomModalProps<BaseProps extends OpenModalCardProps | OpenModalPageProps, AdditionalProps extends object = object> = AdditionalProps & Pick<OpenModalReturn<Omit<BaseProps, 'id'>>, 'close' | 'update'> & {
    modalProps: BaseProps;
};
export type CustomModalPayload<BaseProps extends OpenModalCardProps | OpenModalPageProps, AdditionalProps extends object = object> = {
    id?: string | undefined;
...
export type ModalManagerApi = {
     ...
     */
    openCustomModalCard: <AdditionalProps extends object>(props: CustomModalPayload<OpenModalCardProps, AdditionalProps> | React.ComponentType<CustomModalProps<OpenModalCardProps, AdditionalProps>>) => OpenCardReturn;
    /**
     * Метод для открытия кастомного модального окна на базе `ModalPage`.
     */
    openCustomModalPage: <AdditionalProps extends object>(props: CustomModalPayload<OpenModalPageProps, AdditionalProps> | React.ComponentType<CustomModalProps<OpenModalPageProps, AdditionalProps>>) => OpenPageReturn;
    /**
